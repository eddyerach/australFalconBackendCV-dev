...
#plt.show()
plt.savefig('aug3_2000it_l2reg_epochs2000_lr001_arq-modelRic_0614_loss_1_ago30.png')

##evaluacion en dataset test
torch.save(model, 'aug3_2000it_l2reg_epochs2000_lr001_arq-modelRic_0614_model1_ago30.pth')
model.eval()
y_pred = model(X_test)
row_list = []
...
df.to_csv('aug3_2000it_l2reg_epochs2000_lr001_arq-modelRic_dnn2_eval2_0614_ago23_dssep_aug30.csv')