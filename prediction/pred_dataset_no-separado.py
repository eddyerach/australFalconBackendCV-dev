...
#plt.show()
plt.savefig('2000it_l2reg_epochs2000_lr001_arq-modelRic_AUG_0614_loss_1_ago29.png')

##evaluacion en dataset test
torch.save(model, '2000it_l2reg_epochs2000_lr001_arq-modelRic_AUG_0614_model1_ago29.pth')
model.eval()
y_pred = model(X_test)
row_list = []
...
df.to_csv('2000it_l2reg_epochs2000_lr001_arq-modelRic_AUG_dnn2_eval2_0614_ago23_dssep_aug29.csv')
