...
import split_data
import split
df = pd.read_csv('AUG_area_racimos-bayas_0614_sep1_th01.csv')
#print(f'data: {data}')
...
#plt.show()
plt.savefig('estado1_man2_sep4.png')

##evaluacion en dataset test
torch.save(model, 'estado1_man2_sep4.pth')
model.eval()
y_pred = model(X_test)
row_list = []
...
df.to_csv('estado1_man2_sep4.csv')