...
import split_data
import split
#name = 'AUG4_area_racimos-bayas_0627_sep10_th01.csv'
...
X_train, X_test, y_train, y_test = split.train_test_split_racimo(new_df_X_names, X, y, train_size=0.9, shuffle=True)
'''
print('****************************************************')
...
df.to_csv('aug5_estado1_todo.csv')
