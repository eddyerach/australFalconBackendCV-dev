...
def load_data():
    ...
    with open("AUG_area_racimos-bayas_0614_ago19_th01.csv", 'r') as f:
    ...
    for row in list_of_dict:
        ...
        prefijo =  ext_prefijo if ext_prefijo != row['imagen'] else 'ori'
